      ...
      <div className="px-6 md:px-24 pb-16">
        {menuItems.map((section) => (
          <div key={section.title} className="mb-10">
            <h3 className="inline-block text-2xl font-semibold bg-gradient-to-r from-khaki to-cream-dark bg-clip-text text-transparent secondary-font">
              {section.title}
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              {section.items.map(([name, price], idx) => (
                <div
                  key={idx}
                  className="flex justify-between border-b-1 border-cream-light py-1 col-span-2 md:col-span-1"
                >
